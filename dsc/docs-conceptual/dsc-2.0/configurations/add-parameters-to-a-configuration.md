...
Like functions, [Configurations][configs] can be parameterized to allow more dynamic behavior based
on user input. The steps are similar to the ones in
[Functions with Parameters][func-overview].
...
Unlike a function, the [CmdletBinding][func-cmdletbinding] attribute adds no functionality. In
addition to [Common Parameters][func-common-params], Configurations can also use the following
built-in parameters, without requiring you to define them.

|        Parameter         |                               Description                                |
| ------------------------ | ------------------------------------------------------------------------ |
| **InstanceName**         | Used in defining [Composite Configurations][config-composite]            |
| **DependsOn**            | Used in defining [Composite Configurations][config-composite]            |
| **PSDSCRunAsCredential** | Deprecated. This parameter is no longer supported.                       |
| **ConfigurationData**    | Used to pass in [Configuration Data][config-data] for the Configuration. |
...
[about_Functions_Advanced_Parameters][func-adv-params].

## Fully parameterized Configuration

We now have a parameterized Configuration that forces the user to specify the **ComputerName** and **ServiceName** parameters, and validates the **State** parameter.
...
- [Write help for DSC Configurations][config-help]
- [Dynamic Configurations][config-flow-control]
- [Use Configuration Data in your Configurations][config-data]
- [Separate Configuration and environment data][separating-env-data]

<!-- Reference Links -->

[func-adv-params]: /powershell/module/microsoft.powershell.core/about/about_Functions_Advanced_Parameters
[func-cmdletbinding]: /powershell/module/microsoft.powershell.core/about/about_functions_cmdletbindingattribute
[func-common-params]: /powershell/module/microsoft.powershell.core/about/about_commonparameters
[config-composite]: compositeconfigs.md
[config-data]: configData.md
[configs]: configurations.md
[config-flow-control]: flow-control-in-configurations.md
[func-overview]: /powershell/module/microsoft.powershell.core/about/about_functions
[separating-env-data]: separatingEnvData.md
[config-help]: configHelp.md
