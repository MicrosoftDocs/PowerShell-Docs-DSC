...
To see the changes for the earlier development of DSC prior to version `3.0.0`, see the
[DSC pre-release changelog](https://github.com/PowerShell/DSC/docs/changelog.md) on
GitHub.
