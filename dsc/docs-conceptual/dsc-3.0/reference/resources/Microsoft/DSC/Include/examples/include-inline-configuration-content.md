...
# Include inline configuration content

This example demonstrates how to use the `Microsoft.DSC/Include` resource to embed a configuration
document and its parameters directly in the parent document. Use inline content when you want to
keep a self-contained configuration in a single file rather than referencing separate files on
disk.
