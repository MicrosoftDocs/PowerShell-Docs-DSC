...
The `Microsoft.DSC.Transitional/WindowsPowerShellScript` resource enables you to run Windows
PowerShell 5.1 scripts inline as part of your DSC configuration. This resource is useful for
executing PowerShell logic that hasn't been fully transitioned to a dedicated DSC resource.
...
1. [Invoke the WindowsPowerShellScript resource with input data][03] - Shows how to pass data to
   this resource.
