...
The following snippet shows how you can invoke the resource to execute a custom command with
[dsc resource set][00].
...
> [!NOTE]
> The output from the command executed by the `runCommandOnSet` resource isn't displayed in the
> console. If you want to capture the output, you should redirect it to a file.
