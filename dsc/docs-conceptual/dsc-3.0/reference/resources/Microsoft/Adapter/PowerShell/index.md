...
The adapter manages the PSDSC resources in PowerShell (`pwsh`), not Windows PowerShell
(`powershell.exe`). To use MOF-based PSDSC resources or PSDSC resources that require Windows
PowerShell, use the [Microsoft.Adapter/WindowsPowerShell][01] adapter.
