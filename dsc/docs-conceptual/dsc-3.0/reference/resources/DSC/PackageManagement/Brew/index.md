...
The `DSC.PackageManagement/Brew` resource enables you to idempotently manage packages using Homebrew
on macOS systems. The resource can:
...
1. [Remove a package][05] - Shows how to uninstall a package.
...
for uniquely identifying the package in the Homebrew package repository.
